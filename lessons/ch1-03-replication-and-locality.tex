...
am l?'''
\flushright -- Daniel Dennett\footnote{Daniel Dennett, Where Am I?\cite{where-am-i}} % TODO cite
\end{quotation}
...
So, what do you actually own when you say \textit{"I have a bitcoin"} if there
...
our society \cite{magic-spell}} which can be used to add some entries to the
