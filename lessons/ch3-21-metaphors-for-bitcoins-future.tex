...
digital natives, spending and [stacking] sats will be second nature to the
bitcoin natives of the future.
...
than $75.000$\footnote{\url{https://bit.ly/luke-nodecount}} nodes are running bitcoin.
