...
\begin{center}
  ...
  \captionof{figure}{Bitcoin's controlled supply}
...
\begin{center}
  ...
  \end{equation}
  \captionof{figure}{Stock-to-flow ratio of gold}
...
\begin{center}
  ...
  \captionof{figure}{Visualization of stock and flow for USD, gold, and Bitcoin}
...
\begin{center}
  ...
  \captionof{figure}{Rising stock-to-flow ratio of bitcoin as compared to gold}
