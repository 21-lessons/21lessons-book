...
\begin{center}
  ...
  \captionof{figure}{fiat --- `Let it be done'}
...
\begin{center}
  ...
  \captionof{figure}{Lydian electrum coin. Picture cc-by-sa Classical Numismatic Group, Inc.}
...
\begin{center}
  ...
  \captionof{figure}{Clipped silver coins of varying severity.}
...
\begin{center}
  ...
  \captionof{figure}{The original `dollar'. Saint Joachim is pictured with his robe and wizard hat. Picture cc-by-sa Wikipedia user Berlin-George}
...
\begin{center}
  ...
  \captionof{figure}{A 1928 U.S. silver dollar. `Payable to the bearer on demand.' Picture cc-by-sa National Numismatic Collection at the Smithsonian Institution}
...
\begin{center}
  ...
  \captionof{figure}{A 1928 U.S. \$100 gold certificate. Picture cc-by-sa National Numismatic Collection, National Museum of American History.}
...
\begin{center}
  ...
  \captionof{figure}{A 2004 series U.S. twenty dollar note used today. `THIS NOTE IS LEGAL TENDER'}
