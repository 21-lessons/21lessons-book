...
First edition. Version 0.3.1, git commit \texttt{4e7f81e}.
...
\newenvironment{docspec}{\begin{samepage}\begin{quotation}\ttfamily\parskip0pt\parindent0pt\ignorespaces}{\end{quotation}\end{samepage}}% command specification environment
